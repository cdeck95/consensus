    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.featuresList}>
          <Text style={styles.featureItem}>🍔 Restaurant recommendations</Text>
          <Text style={styles.featureItem}>👩‍🍳 Recipe suggestions</Text>
          <Text style={styles.featureItem}>🌮 Cuisine preferences</Text>
          <Text style={styles.featureItem}>📍 Local dining options</Text>
        </View>
      </View>
    </SafeAreaView>
  );
